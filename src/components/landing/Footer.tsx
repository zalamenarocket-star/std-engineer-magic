...
const Footer = () => {
  ...
  return (
    <footer className="bg-secondary dark:bg-navy-dark py-10 border-t border-border" role="contentinfo">
      <div className="container text-center">
        <p className="font-heading font-bold text-secondary-foreground text-lg mb-1">
        ...
        <p className="text-secondary-foreground/70 text-xs mb-4">
          {t(
        ...
        <p className="text-secondary-foreground/70 text-xs mb-2">
