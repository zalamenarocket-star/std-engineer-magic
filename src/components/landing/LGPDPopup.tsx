...
const LGPDPopup = () => {
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 z-[60] bg-secondary dark:bg-navy-dark border-t border-border p-4 md:p-6">
      <div className="container flex flex-col sm:flex-row items-center justify-between gap-4">
        <p className="text-secondary-foreground/90 text-sm text-center sm:text-left">
          {t(
